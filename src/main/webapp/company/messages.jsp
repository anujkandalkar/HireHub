...
<section class="py-5 bg-light">
    <div class="container">
        <div class="mb-4">
            <h3 class="fw-bold text-dark mb-1">Sent & Received Messages</h3>
            <p class="text-muted mb-0">Direct communications with job applicants</p>
        </div>
        ...
        <div class="row g-4">
                ...
                for (Message msg : messages) { %>
                    <div class="col-lg-8 mx-auto">
                        <div class="card border-0 shadow-sm rounded-4 p-4 bg-white mb-3">
                            ...
                            <div class="small text-muted mb-3">Recipient: <%= msg.getReceiverName() %></div>
            ...
            <%  }
                ...
                <div class="col-12 text-center py-5">
                    <p class="text-muted">No messages sent or received yet.</p>
                </div>
            <% } %>
        </div>
    </div>
