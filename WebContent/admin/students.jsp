...
<section class="py-5 bg-light">
    <div class="container">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            ...
            <form action="${pageContext.request.contextPath}/admin/students" method="get" class="d-flex flex-column flex-sm-row gap-2">
                <div class="search-field">
                    <i class="bi bi-search search-icon text-primary"></i>
                    <input type="text" name="search" class="form-control" placeholder="Search name or email..." value="<%= request.getAttribute("search") != null ? request.getAttribute("search") : "" %>">
                </div>
