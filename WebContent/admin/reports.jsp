...
<% request.setAttribute("pageTitle", "Admin - Recruitment Reports & Analytics"); %>
<jsp:include page="/includes/header.jsp" />

<section class="py-5 bg-light">
    <div class="container">
        <div class="mb-4">
            <h3 class="fw-bold text-dark mb-1"><i class="bi bi-graph-up-arrow me-2 text-primary"></i>Recruitment Analytics & Platform Summary</h3>
            <p class="text-muted mb-0">System performance metrics and application conversion funnel</p>
        </div>
        ...
        <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5 bg-white mb-4">
            <h5 class="fw-bold text-dark mb-4">Application Recruitment Pipeline Breakdown</h5>
            ...
            <div class="mb-3">
                <div class="d-flex justify-content-between mb-1">
                    <span class="fw-semibold">Applied (<%= applied %>)</span>
                    <span class="text-muted"><%= (applied * 100 / total) %>%</span>
                </div>
                <div class="progress" style="height: 12px;">
                    <div class="progress-bar bg-primary" role="progressbar" style="width: <%= (applied * 100 / total) %>%;"></div>
                </div>
            </div>

            <div class="mb-3">
                <div class="d-flex justify-content-between mb-1">
                    <span class="fw-semibold">Under Review (<%= review %>)</span>
                    <span class="text-muted"><%= (review * 100 / total) %>%</span>
                </div>
                <div class="progress" style="height: 12px;">
                    <div class="progress-bar bg-secondary" role="progressbar" style="width: <%= (review * 100 / total) %>%;"></div>
                </div>
            </div>

            <div class="mb-3">
                <div class="d-flex justify-content-between mb-1">
                    <span class="fw-semibold">Shortlisted Candidates (<%= shortlisted %>)</span>
                    <span class="text-muted"><%= (shortlisted * 100 / total) %>%</span>
                </div>
                <div class="progress" style="height: 12px;">
                    <div class="progress-bar bg-info" role="progressbar" style="width: <%= (shortlisted * 100 / total) %>%;"></div>
                </div>
            </div>

            <div class="mb-3">
                <div class="d-flex justify-content-between mb-1">
                    <span class="fw-semibold">Task Assigned (<%= task %>)</span>
                    <span class="text-muted"><%= (task * 100 / total) %>%</span>
                </div>
                <div class="progress" style="height: 12px;">
                    <div class="progress-bar bg-warning" role="progressbar" style="width: <%= (task * 100 / total) %>%;"></div>
                </div>
            </div>

            <div class="mb-3">
                <div class="d-flex justify-content-between mb-1">
                    <span class="fw-semibold">Interview Scheduled (<%= interview %>)</span>
                    <span class="text-muted"><%= (interview * 100 / total) %>%</span>
                </div>
                <div class="progress" style="height: 12px;">
                    <div class="progress-bar bg-purple" role="progressbar" style="width: <%= (interview * 100 / total) %>%; background-color: #8b5cf6;"></div>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="progress" style="height: 12px;">
                    <div class="progress-bar bg-success" role="progressbar" style="width: <%= (selected * 100 / total) %>%;"></div>
                </div>
            </div>
            ...
            <div class="mb-0">
                ...
                <div class="progress" style="height: 12px;">
                    <div class="progress-bar bg-danger" role="progressbar" style="width: <%= (rejected * 100 / total) %>%;"></div>
                </div>
            </div>
        </div>
    </div>
