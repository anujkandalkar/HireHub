    ...
    <div class="container">
        <form action="${pageContext.request.contextPath}/jobs" method="get" class="row g-3 align-items-end">
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="input-group">
                    <span class="input-group-text bg-white"><i class="bi bi-geo-alt text-info"></i></span>
            ...
            <div class="col-lg-3 col-md-3">
                <label class="form-label fw-bold small mb-1"><i class="bi bi-briefcase me-1 text-secondary"></i>Job Type</label>
