...
<% request.setAttribute("pageTitle", "Register Account - HireHub Job Portal"); %>
            ...
            <div class="col-lg-8 col-md-10">
                <div class="card border-0 shadow-lg rounded-4 p-4 p-md-5 bg-white">
                    <div class="text-center mb-4">
                        <h3 class="fw-bold text-dark mb-1">Create Your HireHub Account</h3>
                        <p class="text-muted small">Select your account type to get started</p>

                        <!-- Role Selector Pills -->
                        <div class="btn-group w-100 mt-3 p-1 bg-light rounded-3" role="group">
                            <input type="radio" class="btn-check" name="roleToggle" id="roleStudent" value="STUDENT" checked onclick="toggleRoleForm('STUDENT')">
                            <label class="btn btn-outline-primary border-0 rounded-3 py-2 fw-semibold" for="roleStudent">
                                <i class="bi bi-person-badge me-1"></i> Job Seeker / Student
                            </label>

                            <input type="radio" class="btn-check" name="roleToggle" id="roleCompany" value="COMPANY" onclick="toggleRoleForm('COMPANY')">
                            <label class="btn btn-outline-primary border-0 rounded-3 py-2 fw-semibold" for="roleCompany">
                                <i class="bi bi-building me-1"></i> Company / Recruiter
                            </label>
                        </div>
                    </div>
                    ...
                    <form action="${pageContext.request.contextPath}/register" method="post" enctype="multipart/form-data" id="regForm" onsubmit="return validateRegistrationForm()">
                        ...
                        <div id="studentFields">
                            <h5 class="fw-bold border-bottom pb-2 mb-3 text-primary"><i class="bi bi-person-vcard me-2"></i>Personal & Education Details</h5>
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Education Degree</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="graduationYear" class="form-control" placeholder="2024" min="2000" max="2030">
                                </div>
                                <div class="col-md-6">
                                ...
                                <!-- RESUME UPLOAD FIELD -->
                                <div class="col-md-12">
                                    <label class="form-label fw-semibold">Resume (PDF, DOC, DOCX — Maximum 5 MB) <span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-text text-muted" id="resumeHelp">Upload your resume in PDF, DOC, or DOCX format (Max 5 MB). PDF is recommended.</div>
                        ...
                        <div id="companyFields" style="display: none;">
                            <h5 class="fw-bold border-bottom pb-2 mb-3 text-primary"><i class="bi bi-building me-2"></i>Company Details</h5>
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <label class="form-label fw-semibold">Company Overview / Description</label>
                                    <textarea name="description" class="form-control" rows="3" placeholder="Briefly describe your company..."></textarea>
                                </div>
                            </div>
                        </div>

                        <button type="submit" id="submitBtn" class="btn btn-primary w-100 py-2.5 rounded-3 fw-bold fs-6 mb-3">
                            <i class="bi bi-check-circle-fill me-2"></i>Complete Registration
                        </button>
                    </form>

                    <div class="text-center text-muted small">
                        Already have an account? <a href="${pageContext.request.contextPath}/login.jsp" class="fw-bold text-primary text-decoration-none">Log In</a>
                    </div>
                </div>
            </div>
        </div>
